...
class PreferencesTabBarFactory extends AbstractFactory {
   public Object newInstance( FactoryBuilderSupport builder, Object name, Object value, Map attributes )
      ...
      boolean unified = attributes.remove("unified") ?: false
      def tabBar = unified ? MacWidgetFactory.createUnifiedPreferencesTabBar() : new PreferencesTabBar()
   ...
   public void setChild(FactoryBuilderSupport builder, Object parent, Object child) {
      if( child instanceof PreferencesTab ) {
         builder.parentContext.tabBar.addTab(child.text, child.icon, child.actionListener)
      } else {
